...
import com.palsoft.cyclingfront.presenters.LoginPresenter;
...
public class LoginActivity extends BaseActivity implements LoginPresenter.ILogin {
	...
	private String mEmail = "lpalac4@gmail.com";
	private String mPassword = "foobar";
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean>
    {
		...
		protected Boolean doInBackground(Void... params)
        {
            ...
            String email = "lpalac4@gmail.com";
	...
	{
		CFApplication.getAppSettings().saveLoginCredentials(mEmail, mPassword);
